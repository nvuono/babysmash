...
namespace BabySmash.Music
{
    public class Synth
    {
        public static readonly MixingSampleProvider msp = new MixingSampleProvider(WaveFormat.CreateIeeeFloatWaveFormat(44100, 1));
        ...
        static double[] WaveTable = null;
        static double[] AdsrTable = null;


        public Synth()
        {
            WaveTable = CreateWavetable();
            AdsrTable = CreatedAdsrEnvelope();
            msp.ReadFully = true;
            ((WaveOutEvent)OutputDevice).NumberOfBuffers = 16;
